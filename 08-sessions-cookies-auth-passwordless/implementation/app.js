require('dotenv').config(); // дозволяє завантажувати змінні оточення зі файлу .env у проект, тим самим приховуючи критичні данні
...
if (!process.env.SESSION_SECRET) {
  // Викидаємо помилку, якщо немає важливих змінних оточення
  throw new Error('Error: SESSION_SECRET variable not set in .env file');
}
...
app.use(session({
  ...
  secret: process.env.SESSION_SECRET, // Ваш секрет для кукі. Беремо секрет із змінних оточення
